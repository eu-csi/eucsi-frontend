...
//           <div
//             className={`w-1.5 h-1.5 rounded-full ${
//               metric.isLive ? "bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)]" : "bg-red-500"
//             }`}
//           />
//           <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wide leading-tight">
//             {metric.label}
...
//           {target != null && (
//             <div className="flex justify-between text-[11px]">
//               <span className="text-slate-400">{metric.euTarget ? "EU Target" : "WHO Threshold"}</span>
//               <span className="font-semibold text-slate-700">
//                 {target} {metric.unit}
//               </span>
//             </div>
...
//     // STRICT RECOVERY: Only display if value physically exists in DB response
//     if (currentValue !== null && currentValue !== undefined) {
//       result[m.key] = {
//         value: currentValue,
...
//       };
//     } else {
//       // Explicitly set to empty so it displays '—' instead of guessing old mock trends
//       result[m.key] = {
//         value: "—",
//         trend: undefined,
//         benchmark: benchmark ?? null,
...
//               <span
//                 className={`text-[11px] font-bold px-2 py-0.5 rounded-full ${
//                   sdg.type === "direct" ? "bg-blue-100 text-blue-700" : "bg-amber-100 text-amber-700"
//                 }`}
//               >
//                 {sdg.type === "direct" ? "Direct" : "Indirect"}
//               </span>
...
//                     <div
//                       className="h-full rounded-full transition-all duration-500"
//                       style={{ width: `${displayScore}%`, background: sdg.color }}
//                     />
//                   </div>
//                   <p className="text-[10px] text-slate-400 mt-1">
//                     {countryYearScores?.cluster ?? "—"}
...
//             <div>
//               <h3 className="font-display font-bold text-blue-800 mb-1">CSI Calculation Formula</h3>
//               <p className="text-xs text-blue-600">Each SDG contributes equally to the Composite Sustainability Index</p>
//             </div>
//             <div className="bg-white rounded-xl px-5 py-3 border border-blue-200 text-center">
...
//                 <thead>
//                   <tr className="bg-slate-50 border-b border-slate-100">
//                     {["Metric", "Unit", "Direction", "EU Target", "WHO Threshold", "Description"].map((h) => (
...
//                       <td className="px-5 py-3 font-semibold text-slate-800">{m.label}</td>
//                       <td className="px-5 py-3">
//                         <code className="text-xs bg-slate-100 px-1.5 py-0.5 rounded text-slate-600">{m.unit}</code>
//                       </td>
//                       <td className="px-5 py-3">
//                         <span
//                           className={`text-xs font-bold px-2 py-0.5 rounded-full ${
//                             m.higherIsBetter ? "bg-green-100 text-green-700" : "bg-red-100 text-red-600"
//                           }`}
//                         >
//                           {m.higherIsBetter ? "Higher" : "Lower"}
//                         </span>
